 ...
 */
public interface IIntegralDao extends IBaseDao {
     ...
     */
    int saveIntegral(int userId,int score,int score_type,String source,int available_integral,int total_integral,Timestamp createTime);
